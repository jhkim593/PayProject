...
public class ExceptionAdvice {
    ...
    protected ResponseEntity exceedCancelPayException(HttpServletRequest request, ExceedCancelPayException e){
        return new ResponseEntity(DefaultResponseVO.res(ResponseMessage.PAY_CANCEL_EXCEED,false), HttpStatus.BAD_REQUEST);
    }
    ...
    protected ResponseEntity exceedVatException(HttpServletRequest request, ExceedVatException e){
        return new ResponseEntity(DefaultResponseVO.res( ResponseMessage.PAY_CANCEL_VAT_EXCEED,false), HttpStatus.BAD_REQUEST);
    }
    ...
    protected ResponseEntity vatExceedPriceException(HttpServletRequest request, VatExceedPriceException e){
        return new ResponseEntity(DefaultResponseVO.res( ResponseMessage.VAT_EXCEED_PAY,false), HttpStatus.BAD_REQUEST);
    }
    ...
    protected ResponseEntity httpMessageNotReadableException(HttpServletRequest request, HttpMessageNotReadableException e){
        return new ResponseEntity(DefaultResponseVO.res("요청 형식 오류가 발생했습니다.",false), HttpStatus.INTERNAL_SERVER_ERROR);
    }
